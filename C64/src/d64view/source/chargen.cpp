/*
   ...
   $Id: chargen.cpp,v 1.4 2003/09/08 20:55:45 vividos Exp $

*/
/*! \file chargen.cpp

   \brief character bitmap

   character values extracted from c64 memory, from $d000-$dfff.
...
//! data from c64 "chargen" file
c64_byte chargen[4096] =
{
